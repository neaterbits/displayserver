...
public final class KeyRelease extends BaseWindowEvent {

    private final KEYCODE detail;
    
    public static KeyRelease decode(XWindowsProtocolInputStream stream) throws IOException {
        ...
        return new KeyRelease(sequenceNumber, detail, eventState);
    }
    
    public KeyRelease(CARD16 sequenceNumber, KEYCODE detail, EventState eventState) {
