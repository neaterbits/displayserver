...
public class OpCodes {
	...
	public static final int SET_SELECTION_OWNER = 22;
	public static final int GET_SELECTION_OWNER = 23;
	public static final int CONVERT_SELECTION = 24;
	
	public static final int SEND_EVENT = 25;
	
	public static final int GRAB_POINTER = 26;
	
	public static final int GRAB_BUTTON = 28;
	
	public static final int GRAB_KEY = 33;
    ...
    public static final int LIST_FONTS = 49;
    public static final int LIST_FONTS_WITH_INFO = 50;
