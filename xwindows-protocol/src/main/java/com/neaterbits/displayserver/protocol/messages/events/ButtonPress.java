...
public class ButtonPress extends BaseWindowEvent {

    private final BUTTON detail;
    
    public static ButtonPress decode(XWindowsProtocolInputStream stream) throws IOException {
        ...
        return new ButtonPress(sequenceNumber, detail, eventState);
    }
    
    public ButtonPress(CARD16 sequenceNumber, BUTTON detail, EventState eventState) {
